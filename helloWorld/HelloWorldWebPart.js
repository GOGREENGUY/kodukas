...
var HelloWorldWebPart = /** @class */ (function (_super) {
    ...
    HelloWorldWebPart.prototype.getPromise = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.context.spHttpClient
                        .get(this.context.pageContext.web.absoluteUrl +
                        "/_api/web/lists/GetByTitle('Alert State')/Items", SPHttpClient.configurations.v1)
                        .then(function (response) { return response.json(); })
                        .then(function (data) {
                        return data.value.slice(-1)[0]['Title'];
                    })];
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _a = this.domElement;
                        _c = (_b = "\n    <div class=\"".concat(styles.alertState, "\">ALERT STATE</div>\n    <div class=\"").concat(styles.value, "\">")).concat;
                        return [4 /*yield*/, this.getPromise()];
                    case 1:
                        _a.innerHTML = _c.apply(_b, [_d.sent(), "</div>"]);
                        return [2 /*return*/];
                }
            });
        });
